...
import com.etrade.corelib.security.SignManager
import java.util.ArrayList

class sLoginSample2 : AppCompatActivity() {
...
//    }
    ...
    fun setControl() {
        ...
        if (items.isEmpty() == true) {
            ...
            m_buttonCert.setVisibility(View.INVISIBLE)
